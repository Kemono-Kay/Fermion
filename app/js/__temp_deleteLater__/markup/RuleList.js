 ...
 * Therefore this function needs to be provided to finalise the rule list.
 * @param {standardizeColor} standardizeColor - get the function for standardising colors.
 */
const getList = (standardizeColor) => [
...
/**
 * Standardizes a color to an RGB hex format.
 * @callback standardizeColor
 * @param {String} color - the color, in any valid CSS format.
